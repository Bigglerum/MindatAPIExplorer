  ...
  return (
    <div>
      <Card className="mb-6">
        ...
        <CardContent>
          <MineralSpeciesSearch onSelect={handleSelectMineral} />
        </CardContent>
      </Card>
