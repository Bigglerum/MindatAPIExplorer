...
// Updated to match the Mindat API crystal class IDs
const crystalClassMap = [
  { cclass: 1, name: "Pedial", system: "Triclinic", symbol: "1" },
  { cclass: 2, name: "Pinacoidal", system: "Triclinic", symbol: "-1" },
  { cclass: 3, name: "Domatic", system: "Monoclinic", symbol: "m" },
  { cclass: 4, name: "Sphenoidal", system: "Monoclinic", symbol: "2" },
  ...
  { cclass: 12, name: "Trapezohedral", system: "Trigonal", symbol: "3 2" },
  { cclass: 13, name: "Hexagonal Scalenohedral", system: "Trigonal", symbol: "-3m" },
  { cclass: 14, name: "Trigonal Dipyramidal", system: "Hexagonal", symbol: "-6" },
  { cclass: 15, name: "Pyramidal", system: "Hexagonal", symbol: "6" },
  { cclass: 16, name: "Dipyramidal", system: "Hexagonal", symbol: "6/m" },
